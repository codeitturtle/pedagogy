...
<head>
    ...
    <title>student (Backup 1566291856102)</title>
    ...
    <div class="row">
        <div class="col-lg-4 col-xl-2">
            <div class="list-group"><a href="#list-home" class="list-group-item list-group-item-action" data-toggle="list" style="width: 200px;">My Programme</a><a href="#list-profile" class="list-group-item list-group-item-action" data-toggle="list" style="width: 200px;">Notes</a>
                <a
                    href="#list-messages" class="list-group-item list-group-item-action" data-toggle="list" style="width: 200px;">Assignment Receive</a
                    >
                    <a
                    href="#list-messages" class="list-group-item list-group-item-action" data-toggle="list" style="width: 200px;">Assignment Send</a
                    ><a href="#list-settings" class="list-group-item active list-group-item-action" data-toggle="list" style="width: 200px;">Notices</a><a href="#list-settings" class="list-group-item list-group-item-action" data-toggle="list" style="width: 200px;">Log Out</a></div>
        </div>
        <div class="col offset-xl-0">
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <h2 class="ml-2" style="text-decoration: underline; color: #700000 ">Emergency Notice</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box1">
                        <h3 class="ml-2" style=" color: #222222; font-family: sans-serif">Titlet: First term exam routine</h3>
                         <p class="ml-5" style=" color: #222222;">2019/08/26</p>
                         <div class="box2">
                             <img src="assets/img/ic-lock.png" alt="" width="120px" height="120px">
                         </div>
